      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            ...
            <div className="text-[11px] text-slate-300">Safe Instrumentation in Endodontics</div>
          </div>
        </div>

        <div className="flex items-center gap-4 text-slate-300 flex-wrap justify-center">
          <a href="/about" className="hover:text-white text-xs">The Book</a>
          <a href="/pricing" className="hover:text-white text-xs">Buy</a>
