...
export default function PricingPage(){
  return (
    <main className="max-w-4xl mx-auto py-12 px-6">
      ...
      <p className="text-slate-300 mb-6">A focused 70-page digital book for clinicians and students who want a safer, more predictable approach to endodontic instrumentation.</p>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="bg-slate-800/60 p-6 rounded-xl shadow-soft border-2 border-brand-500">
          ...
          <p className="text-slate-300">Full 70-page PDF access after manual verification of your Zain Cash or Switch Card payment.</p>
